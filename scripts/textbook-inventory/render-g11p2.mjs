/**
 * Render several grade-11 textbook pages to PNG in one process (visual check of OCR-garbled formulas).
 * Usage: node scripts/textbook-inventory/render-g11p2.mjs <scale> <page> [page...]
 * Output: .smoke/textbook-inventory/g11p2-pages/p<NNN>.png
 */
...
const outDir = path.join(root, '.smoke', 'textbook-inventory', 'g11p2-pages')
