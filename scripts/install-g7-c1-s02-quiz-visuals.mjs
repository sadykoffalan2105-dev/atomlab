/**
 * Install unique g7-c1-s02 quiz visuals from generated Cursor assets.
...
const captions = {
  'g7-c1-s02-q01': 'Тело: масса, форма и размер',
  'g7-c1-s02-q02': 'Предметы — тела, созданные человеком',
  'g7-c1-s02-q03': 'Вещество — совокупность частиц',
  'g7-c1-s02-q04': 'Свойство отличает вещества',
  'g7-c1-s02-q05': 'Физические свойства вещества',
  'g7-c1-s02-q06': 'Химические свойства вещества',
  'g7-c1-s02-q07': 'Примеры химических изменений',
  'g7-c1-s02-q08': 'Тела из железа и вещество железо',
}
...
for (const [id, caption] of Object.entries(captions)) {
  ...
  console.log('OK', id, `${(out.length / 1024).toFixed(0)} KB`)
}

console.log('Installed 8 unique quiz visuals for g7-c1-s02 (§ Вещество и его свойства)')
