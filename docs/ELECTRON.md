...
**Скачать v1.2.9:** [GitHub Releases](https://github.com/sadykoffalan2105-dev/atomlab/releases/tag/v1.2.9)
- `ATOMLAB-1.2.9-portable.exe` — без установки
- `ATOMLAB-1.2.9-setup.exe` — установщик
...
```
release/
├── ATOMLAB-1.2.9-portable.exe      ← portable, без установки
├── ATOMLAB-1.2.9-setup.exe         ← NSIS-установщик
