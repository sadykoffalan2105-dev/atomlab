...
**Скачать v1.1.4:** [GitHub Releases](https://github.com/sadykoffalan2105-dev/atomlab/releases/tag/v1.1.4)
- `ATOMLAB-1.1.4-portable.exe` — без установки
- `ATOMLAB-1.1.4-setup.exe` — установщик
