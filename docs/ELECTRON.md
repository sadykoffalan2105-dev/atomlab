...
**Скачать v1.2.1:** [GitHub Releases](https://github.com/sadykoffalan2105-dev/atomlab/releases/tag/v1.2.1)
- `ATOMLAB-1.2.1-portable.exe` — без установки
- `ATOMLAB-1.2.1-setup.exe` — установщик
...
```
release/
├── ATOMLAB-1.2.1-portable.exe      ← portable, без установки
├── ATOMLAB-1.2.1-setup.exe         ← NSIS-установщик
