...
**Скачать v1.2.2:** [GitHub Releases](https://github.com/sadykoffalan2105-dev/atomlab/releases/tag/v1.2.2)
- `ATOMLAB-1.2.2-portable.exe` — без установки
- `ATOMLAB-1.2.2-setup.exe` — установщик
...
```
release/
├── ATOMLAB-1.2.2-portable.exe      ← portable, без установки
├── ATOMLAB-1.2.2-setup.exe         ← NSIS-установщик
