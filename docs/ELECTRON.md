...
**Скачать v1.2.8:** [GitHub Releases](https://github.com/sadykoffalan2105-dev/atomlab/releases/tag/v1.2.8)
- `ATOMLAB-1.2.8-portable.exe` — без установки
- `ATOMLAB-1.2.8-setup.exe` — установщик
...
```
release/
├── ATOMLAB-1.2.8-portable.exe      ← portable, без установки
├── ATOMLAB-1.2.8-setup.exe         ← NSIS-установщик
