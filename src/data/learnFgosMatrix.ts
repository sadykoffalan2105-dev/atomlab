...
const FULL_G7_PREFIXES = new Set(
  [
    ...
    ...Array.from({ length: 7 }, (_, i) => `g7-c3-s${String(i + 1).padStart(2, '0')}`),
    ...Array.from({ length: 6 }, (_, i) => `g7-c4-s${String(i + 1).padStart(2, '0')}`),
    ...Array.from({ length: 3 }, (_, i) => `g7-c5-s${String(i + 1).padStart(2, '0')}`),
  ],
)

const BLOCK_BY_GRADE_CHAPTER: Record<string, string> = {
  'g7-c1': '7.1 Вещество. Химия как наука',
  'g7-c2': '7.2 Атом. Химический элемент',
  'g7-c3': '7.3 Воздух. Горение',
  'g7-c4': '7.4 Водород. Вода. Растворы',
  'g7-c5': '7.5 Химия в жизни',
