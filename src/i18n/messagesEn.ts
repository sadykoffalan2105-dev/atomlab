...
export const messagesEn: Record<MessageKey, string> = {
  ...
  'organicLab.lead':
    'Kimyo 10 curriculum: topic path, 3D molecules, structure building, and equations.',
  'organicLab.programLead':
    'Follow textbook chapters: view a molecule, build it in 3D, assemble the equation.',
  ...
  'organicLab.openBuilder': 'Open builder',
