...
export const messagesRu = {
  ...
  'organicLab.lead':
    'Учебная программа Kimyo 10: путь по темам, 3D-молекулы, сборка структуры и уравнения.',
  'organicLab.programLead':
    'Пройдите уроки по главам учебника: смотрите молекулу, соберите её в 3D, соберите уравнение.',
  ...
  'organicLab.openBuilder': 'Открыть сборку',
