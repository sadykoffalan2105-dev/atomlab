 ...
 *   2 «Сублимация и диссоциация» — два атома Na выходят из металла, остальной металл гаснет
 *                                 до нуля и выключается; связь Cl–Cl рвётся гомолитически;
 *   3 «Отдача и приём электрона» — электрон летит по кубической кривой Безье от Na к Cl; в кадр
 ...
 *   5 «Кристаллическая решётка»  — 3×3×3 ячейки каменной соли, октаэдры КЧ 6:6, рёбра ячеек;
...
export type NaclCueId =
  ...
  | 'contact'
  /** решётка 3×3×3 собрана, рёбра ячеек и октаэдры КЧ видны */
  | 'lattice'
