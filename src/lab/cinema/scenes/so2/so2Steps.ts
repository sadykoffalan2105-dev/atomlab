 ...
 *                              и МОЛЕКУЛА O₂ (120,8 пм); сера горит синим пламенем;
 *   2 «Кольцо раскрывается»  — рвутся ДВЕ связи S–S, один атом серы уходит из короны;
 *                              стадия эндотермическая (+277,2 кДж на моль атомов S);
