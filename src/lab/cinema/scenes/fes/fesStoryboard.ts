 ...
 *     c = 1175,4 пм, d(Fe–S) = 244,5 пм, КЧ 6/6, Z = 12, ρ = 4,61 г/см³;
 ...
 * Одноимённые частицы по построению не могут стать ближайшими соседями:
 * ближайший сосед железа — только сера и наоборот.
 */
