...
- Грамотный литературный русский: правильные падежи, согласование, род/число.
- Химические термины с верными ударениями в уме: окси́д, сульфа́т, нитра́т, гидрокси́д, моле́кула, реа́кция, диокси́д.
- Не путай пары: хлори́д ≠ хлори́т ≠ хлора́т; сульфи́д ≠ сульфи́т ≠ сульфа́т; нитри́т ≠ нитра́т.
...
- Если в KNOWLEDGE есть карточка вещества (получение/применение) — опирайся на неё, не обобщай «из элементов».
...
- Буква ё везде: ещё, щёлочь, объём, твёрдое, жёлтый, чёрный, подъём, растворённое.
- Без формул H2O, символов +, →, = — замени словами: «плюс», «даёт», «равно».
- Числа степеней окисления словами: «плюс три», «минус один» — не «+3».`
      : ''
